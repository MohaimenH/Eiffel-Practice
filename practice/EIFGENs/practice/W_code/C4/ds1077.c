...
extern EIF_TYPED_VALUE F1077_8895(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1077_8896(EIF_REFERENCE);
extern void F1077_8897(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1077_8898(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1077_8895 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1076, Current, 0, 0, 15130);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1076, Current, 15130);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0xF8000451, 0,0); /* Result */
	{
		EIF_TYPE_INDEX typarr0[] = {0xFF01,1105,0,0,0,0,0xFFFF};
		EIF_TYPE typres0;
		{
			EIF_TYPE l_type;
...
EIF_TYPED_VALUE F1077_8896 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1077_8897 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1076, Current, 0, 1, 15128);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1076, Current, 15128);
	RTCC(arg1, 1076, l_feature_name, 1, RTWCT(6404, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 6404, 0xF8000450, 0); /* hash_function */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
EIF_TYPED_VALUE F1077_8898 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1076, Current, 1, 1, 15129);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1076, Current, 15129);
	RTIV(Current, RTAL);
	RTHOOK(1);
	if (EIF_TRUE) {
		RTHOOK(2);
