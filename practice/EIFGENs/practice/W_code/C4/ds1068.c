...
extern EIF_TYPED_VALUE F1068_8585(EIF_REFERENCE);
extern void F1068_9408(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F1068_8585 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1067, Current, 0, 0, 14876);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1067, Current, 14876);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1068_9408 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1067, Current, 0, 9407);
	RTSA(dtype);
	RTME(dtype, 0);
