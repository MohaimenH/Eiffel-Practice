...
extern EIF_TYPED_VALUE F1082_8585(EIF_REFERENCE);
extern void F1082_9408(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F1082_8585 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1081, Current, 0, 0, 14878);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1081, Current, 14878);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1082_9408 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1081, Current, 0, 9407);
	RTSA(dtype);
	RTME(dtype, 0);
