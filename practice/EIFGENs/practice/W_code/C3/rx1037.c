...
body:;
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(6038, dtype)) = (EIF_INTEGER_32) arg1;
	RTHOOK(4);
	RTDBGAA(Current, dtype, 6052, 0xF8000288, 0); /* byte_code */
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(6055, dtype)) = (EIF_INTEGER_32) arg1;
	RTHOOK(7);
	RTDBGAA(Current, dtype, 6053, 0xF800024D, 0); /* character_sets */
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(6054, dtype)) = (EIF_INTEGER_32) loc3;
	...
	if (arg2) {
		...
		for (;;) {
			...
			RTNHOOK(11,1);
			ui4_1 = loc2;
			tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(2673, "item", loc4))(loc4, ui4_1x)).it_b);
			ub1 = (EIF_BOOLEAN) !tb1;
			ui4_1 = loc1;
