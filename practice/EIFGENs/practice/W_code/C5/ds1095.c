...
extern EIF_TYPED_VALUE F1095_8602(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1095_8604(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1095_8606(EIF_REFERENCE);
extern void F1095_8610(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
/* {DS_TABLE}.value */
EIF_TYPED_VALUE F1095_8602 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1094, Current, 0, 1, 14883);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1094, Current, 14883);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1095_8604 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1094, Current, 2, 0, 14884);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1094, Current, 14884);
	RTIV(Current, RTAL);
	RTHOOK(1);
	loc2 = RTCCL(Current);
	{
		EIF_TYPE_INDEX typarr0[] = {0xFF01,1094,0,0,0xFF02,0,0,0xFFFF};
		EIF_TYPE typres0;
		{
			EIF_TYPE l_type;
			l_type = RTWCT(6226, dtype, dftype);
...
/* {DS_TABLE}.has_void */
EIF_TYPED_VALUE F1095_8606 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1094, Current, 2, 0, 14885);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1094, Current, 14885);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = '\0';
	tb2 = '\0';
...
/* {DS_TABLE}.swap */
void F1095_8610 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1094, Current, 1, 2, 14886);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1094, Current, 14886);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("valid_k", EX_PRE);
