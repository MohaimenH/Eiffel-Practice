...
extern EIF_TYPED_VALUE F1113_8360(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1113_8361(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1113_8360 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ub2 ub2x.it_b
	...
	RTEAA(l_feature_name, 1112, Current, 0, 2, 14642);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1112, Current, 14642);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1113_8361 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define arg2 arg2x.it_b
	...
	RTEAA(l_feature_name, 1112, Current, 4, 2, 14643);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1112, Current, 14643);
	RTIV(Current, RTAL);
	RTHOOK(1);
