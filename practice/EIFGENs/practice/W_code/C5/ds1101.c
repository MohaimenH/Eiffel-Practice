...
extern void F1101_8550(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1101_8551(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1101_8552(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1101_8553(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1101_8554(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1101_8555(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1101_8556(EIF_REFERENCE);
extern void F1101_9407(EIF_REFERENCE, int);
...
void F1101_8550 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1100, Current, 0, 1, 14845);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1100, Current, 14845);
	RTCC(arg1, 1100, l_feature_name, 1, RTWCT(6201, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 6201, 0xF8000435, 0); /* container */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(6201, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 6200, 0xF8000442, 0); /* table_cursor */
...
void F1101_8551 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1100, Current, 0, 2, 14846);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1100, Current, 14846);
	RTCC(arg1, 1100, l_feature_name, 1, RTWCT(6201, dtype, Dftype(Current)), 0x00);
	RTCC(arg2, 1100, l_feature_name, 2, RTWCT(6200, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("a_container_not_void", EX_PRE);
...
EIF_TYPED_VALUE F1101_8552 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F1101_8553 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1100, Current, 0, 0, 14848);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1100, Current, 14848);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1101_8554 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1100, Current, 0, 0, 14849);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1100, Current, 14849);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6200, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
...
EIF_TYPED_VALUE F1101_8555 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F1101_8556 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1101_9407 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1100, Current, 0, 9406);
	RTSA(dtype);
	RTME(dtype, 0);
