...
extern void F1092_8530(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F1092_8530 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1091, Current, 1, 1, 14819);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1091, Current, 14819);
	{
