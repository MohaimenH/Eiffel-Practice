...
extern EIF_TYPED_VALUE F1094_8721(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1094_8721 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1093, Current, 0, 0, 14982);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1093, Current, 14982);
	RTIV(Current, RTAL);
