...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1117, Current, 0, 1, 13588);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1117, Current, 13588);
	RTIV(Current, RTAL);
...
#define ub2 ub2x.it_b
	...
	RTEAA(l_feature_name, 1117, Current, 1, 2, 13589);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1117, Current, 13589);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
#define ub2 ub2x.it_b
	...
	RTEAA(l_feature_name, 1117, Current, 2, 1, 13590);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1117, Current, 13590);
	{
		EIF_TYPE_INDEX typarr0[] = {0xFF01,584,0,0,0xFFFF};
		EIF_TYPE typres0;
		{
			EIF_TYPE l_type;
			l_type = RTWCT(5058, dtype, dftype);
...
#define ub2 ub2x.it_b
	...
	RTEAA(l_feature_name, 1117, Current, 1, 1, 13591);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1117, Current, 13591);
	{
		EIF_TYPE_INDEX typarr0[] = {0xFF01,584,0,0,0xFFFF};
		EIF_TYPE typres0;
		{
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1117, Current, 1, 2, 13592);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1117, Current, 13592);
	{
		EIF_TYPE_INDEX typarr0[] = {0xFF01,589,0,0,0xFFFF};
		EIF_TYPE typres0;
		{
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1117, Current, 0, 3, 13593);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1117, Current, 13593);
	{
		EIF_TYPE_INDEX typarr0[] = {0xFF01,589,0,0,0xFFFF};
		EIF_TYPE typres0;
		{
...
#define ub2 ub2x.it_b
	...
	RTEAA(l_feature_name, 1117, Current, 1, 3, 13594);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1117, Current, 13594);
	{
		EIF_TYPE_INDEX typarr0[] = {0xFF01,589,0,0,0xFFFF};
		EIF_TYPE typres0;
		{
...
#define ub2 ub2x.it_b
	...
	RTEAA(l_feature_name, 1117, Current, 1, 2, 13595);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1117, Current, 13595);
	{
		EIF_TYPE_INDEX typarr0[] = {0xFF01,589,0,0,0xFFFF};
		EIF_TYPE typres0;
		{
...
#define ub2 ub2x.it_b
	...
	RTEAA(l_feature_name, 1117, Current, 1, 2, 13596);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1117, Current, 13596);
	{
		EIF_TYPE_INDEX typarr0[] = {0xFF01,589,0,0,0xFFFF};
		EIF_TYPE typres0;
		{
...
#define ub2 ub2x.it_b
	...
	RTEAA(l_feature_name, 1117, Current, 1, 3, 13597);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1117, Current, 13597);
	{
		EIF_TYPE_INDEX typarr0[] = {0xFF01,589,0,0,0xFFFF};
		EIF_TYPE typres0;
		{
