...
extern EIF_TYPED_VALUE F1100_8596(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1100_8597(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1100_8599(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1100_9409(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F1100_8596 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1099, Current, 0, 0, 14879);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1099, Current, 14879);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1100_8597 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1099, Current, 0, 0, 14880);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1099, Current, 14880);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1100_8599 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 1099, Current, 0, 1, 14881);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1099, Current, 14881);
	RTIV(Current, RTAL);
...
void F1100_9409 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1099, Current, 0, 9408);
	RTSA(dtype);
	RTME(dtype, 0);
